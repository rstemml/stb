...
$whitelist = array(
    'statuses/user_timeline.json?screen_name=dxthemes&count=10&include_rts=false&exclude_replies=true'=>true
);

if($config['oauth_access_token']&&$config['oauth_access_token_secret']&&$config['consumer_key']&&$config['consumer_secret']) {
...
// if no tokens, keys and secrets use default feed
$f="http://wpkuzen.com/twitter.php?url=statuses%2Fuser_timeline.json%3Fscreen_name%3Ddxthemes%26count%3D2%26include_rts%3Dfalse%26exclude_replies%3Dtrue";
